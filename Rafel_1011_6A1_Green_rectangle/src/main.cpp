...
const char *fragmentShaderSource = "#version 330 core\n"
    ...
    "{\n"
          "   FragColor = vec4(0.0f, 1.0f, 0.0f, 1.0f);\n" /*vec4(1.0f, 0.0f, 0.0f, 1.0f): This creates a 4D vector with four components, each representing one of the color channels (red, green, blue, and alpha):
            0.0f: Red component (no red).
            1.0f: Green component (full green).
...
int main()
{
    ...
    // --------------------
    GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "MD. Mojahidul Islam Rafel 1011", NULL, NULL);
    if (window == NULL)
    {
    ...
    */
    ...
    while (!glfwWindowShouldClose(window))
    {
       ...
       glClearColor(1.0f, 1.0f, 0.0f, 1.0f);
        ...
        //0 starting index, 6 no. of vertices
